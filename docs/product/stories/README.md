...
| [US-23.7](US-23.7-scripts-docs-reconciliation-closeout.md) | Scripts, tooling & docs reconciliation + epic close-out | Sweep `scripts/`; reconcile docs; consolidate register → seed Epic 24 | Next phase |
