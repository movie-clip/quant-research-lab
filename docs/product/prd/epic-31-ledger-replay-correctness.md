...
| US-31.4 | Fix F-5: stop the bare-symbol fallback substituting a different security (SEMI → US-listed line) | **High** — largest single error ($2,506.93) and the widest blast radius |
