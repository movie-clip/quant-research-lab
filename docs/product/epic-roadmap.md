...
*Living execution snapshot. Updated: 2026-07-05 (Epic 28 — IBKR CSV Importer & Statement-Refresh Resilience **backlog** (3 stories authored); Epic 27 — Financial Calculation Correctness **active** (US-27.1–27.3 done, 6 stories remaining); Epic 25 — Dashboard Performance & Risk Summary complete; Epic 24 — Codebase Improvement active; Epic 26 — Currency Exposure & Risk backlog (research brief only); Epic 23 — dead-code cleanup & codebase review complete; Epics 13/18/19/20/21/22 complete).*
