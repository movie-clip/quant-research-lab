...
_CONSTRUCTION_POLICY_FILTER_ALLOWED_VALUES = {
    ...
    "max_sector_weight_constraint": frozenset(get_args(ConstructionPolicyOptionalConstraintSupport)),
...
def get_construction_policies(
    ...
    max_sector_weight_constraint: str | None = Query(default=None),
    ...
    return list_construction_policies(
        ...
        max_sector_weight_constraint=max_sector_weight_constraint,
