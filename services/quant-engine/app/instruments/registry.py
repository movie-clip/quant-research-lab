...
INSTRUMENT_DEFINITIONS: dict[str, Instrument] = {
    ...
    "SGLD": _instrument("etf-sgld", "SGLD", "Invesco Physical Gold ETC", "etf", "Commodities", "Commodity UCITS ETF", "USD", isin="IE00B579F325"),
    "ICOM": _instrument("etf-icom", "ICOM", "iShares Diversified Commodity Swap UCITS ETF", "etf", "Commodities", "Commodity UCITS ETF", "USD", isin="IE00BDFL4P12"),
    "DFND": _instrument("etf-dfnd", "DFND", "iShares Global Aerospace & Defence UCITS ETF", "etf", "Defense", "Thematic UCITS ETF", "GBP", isin="IE000U9ODG19"),
    "BTEC": _instrument("etf-btec", "BTEC", "iShares Nasdaq US Biotechnology UCITS ETF", "etf", "Health Care", "Sector UCITS ETF", "USD", isin="IE00BYXG2H39"),
    "IUFS": _instrument("etf-iufs", "IUFS", "iShares S&P 500 Financials Sector UCITS ETF", "etf", "Financials", "Sector UCITS ETF", "USD", isin="IE00B4JNQZ49"),
    ...
    "IAUP": _instrument("etf-iaup", "IAUP", "iShares Gold Producers UCITS ETF", "etf", "Commodities", "Commodity UCITS ETF", "USD", isin="IE00B6R52036"),
    "IDFN": _instrument("etf-idfn", "IDFN", "Invesco Defence Innovation UCITS ETF", "etf", "Defense", "Thematic UCITS ETF", "USD", isin="IE000BRM9046"),
    "VDST": _instrument("etf-vdst", "VDST", "Vanguard USD 0-1 Year Treasury Bond UCITS ETF", "etf", "Fixed Income", "Bond UCITS ETF", "USD", isin="IE00BLRPPV00"),
    "COPX": _instrument("etf-copx", "COPX", "Global X Copper Miners ETF", "etf", "Commodities", "Thematic ETF", "USD", isin="IE0003Z9E2Y3"),
