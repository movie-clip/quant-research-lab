  ...
  it('renders the strategy result after running the ETF rotation prototype', async () => {
    const fetchSpy = vi.spyOn(globalThis, 'fetch').mockResolvedValue(
      new Response(JSON.stringify({
        ...
        equity_curve: [{ date: '2024-12-02', strategy_equity: 114.2, benchmark_equity: 108.1, strategy_drawdown_pct: -4.1, benchmark_drawdown_pct: -5.3 }],
        metrics: { total_return_pct: 14.2, benchmark_return_pct: 8.1, excess_return_pct: 6.1, annualized_return_pct: 11.4, max_drawdown_pct: -4.1, benchmark_max_drawdown_pct: -5.3, win_rate_pct: 63.2, average_turnover_pct: 28.4, average_volume_participation_ratio: 1.12 },
    ...
    expect(screen.queryByText('Volume Participation')).toBeNull()
    ...
    expect(screen.getByText('Trailing Return')).toBeTruthy()
    ...
    fireEvent.click(screen.getByText('Trailing Return'))
  ...
  it('shows selected ETF constituent history across all visible quarters even when it only leads at the selected checkpoint', async () => {
    vi.spyOn(globalThis, 'fetch').mockResolvedValue(
      new Response(JSON.stringify({
        ...
        observations: [
          { date: '2025-06-30', rankings: [{ symbol: 'XLF', target_weight: 1, score: 0.2, trailing_return_pct: 20, average_volume: 1000000 }, { symbol: 'XLE', target_weight: 0, score: 0.1, trailing_return_pct: 10, average_volume: 1000000 }], holdings: [{ symbol: 'XLF', target_weight: 1, score: 0.2, trailing_return_pct: 20, average_volume: 1000000 }], leader: 'XLF', leader_score: 0.2, benchmark_return_pct: 2.0, strategy_return_pct: 3.0, average_volume_ratio: 1.1 },
          { date: '2025-09-30', rankings: [{ symbol: 'XLK', target_weight: 1, score: 0.21, trailing_return_pct: 21, average_volume: 1000000 }, { symbol: 'XLE', target_weight: 0, score: 0.12, trailing_return_pct: 12, average_volume: 1000000 }], holdings: [{ symbol: 'XLK', target_weight: 1, score: 0.21, trailing_return_pct: 21, average_volume: 1000000 }], leader: 'XLK', leader_score: 0.21, benchmark_return_pct: 2.1, strategy_return_pct: 3.1, average_volume_ratio: 1.1 },
          { date: '2025-12-31', rankings: [{ symbol: 'XLI', target_weight: 1, score: 0.22, trailing_return_pct: 22, average_volume: 1000000 }, { symbol: 'XLE', target_weight: 0, score: 0.18, trailing_return_pct: 18, average_volume: 1000000 }], holdings: [{ symbol: 'XLI', target_weight: 1, score: 0.22, trailing_return_pct: 22, average_volume: 1000000 }], leader: 'XLI', leader_score: 0.22, benchmark_return_pct: 2.2, strategy_return_pct: 3.2, average_volume_ratio: 1.1 },
          { date: '2026-03-31', rankings: [{ symbol: 'XLE', target_weight: 1, score: 0.33, trailing_return_pct: 33, average_volume: 1000000 }, { symbol: 'XLI', target_weight: 0, score: 0.25, trailing_return_pct: 25, average_volume: 1000000 }], holdings: [{ symbol: 'XLE', target_weight: 1, score: 0.33, trailing_return_pct: 33, average_volume: 1000000 }], leader: 'XLE', leader_score: 0.33, benchmark_return_pct: 2.3, strategy_return_pct: 3.3, average_volume_ratio: 1.1 },
        ],
        equity_curve: [{ date: '2026-03-31', strategy_equity: 110, benchmark_equity: 105, strategy_drawdown_pct: -3, benchmark_drawdown_pct: -4 }],
        metrics: { total_return_pct: 10, benchmark_return_pct: 5, excess_return_pct: 5, annualized_return_pct: 9, max_drawdown_pct: -3, benchmark_max_drawdown_pct: -4, win_rate_pct: 60, average_turnover_pct: 20, average_volume_participation_ratio: 1.1 },
      }), { status: 200, headers: { 'Content-Type': 'application/json' } }),
    )
  ...
  it('keeps quarterly trailing-return cells aligned with the selected ETF history', async () => {
    vi.spyOn(globalThis, 'fetch').mockResolvedValue(
      new Response(JSON.stringify({
        ...
        observations: [
          { date: '2025-03-31', rankings: [{ symbol: 'XLF', target_weight: 1, score: 0.2, trailing_return_pct: 20, average_volume: 1000000 }, { symbol: 'XLK', target_weight: 0, score: 0.19, trailing_return_pct: 19, average_volume: 1000000 }], holdings: [{ symbol: 'XLF', target_weight: 1, score: 0.2, trailing_return_pct: 20, average_volume: 1000000 }], leader: 'XLF', leader_score: 0.2, benchmark_return_pct: 2.0, strategy_return_pct: 3.0, average_volume_ratio: 1.1 },
          { date: '2025-06-30', rankings: [{ symbol: 'XLK', target_weight: 1, score: 0.28, trailing_return_pct: 28, average_volume: 1000000 }, { symbol: 'XLF', target_weight: 0, score: 0.22, trailing_return_pct: 22, average_volume: 1000000 }], holdings: [{ symbol: 'XLK', target_weight: 1, score: 0.28, trailing_return_pct: 28, average_volume: 1000000 }], leader: 'XLK', leader_score: 0.28, benchmark_return_pct: 2.1, strategy_return_pct: 3.1, average_volume_ratio: 1.1 },
          { date: '2025-09-30', rankings: [{ symbol: 'XLK', target_weight: 1, score: 0.54, trailing_return_pct: 54, average_volume: 1000000 }, { symbol: 'XLI', target_weight: 0, score: 0.3, trailing_return_pct: 30, average_volume: 1000000 }], holdings: [{ symbol: 'XLK', target_weight: 1, score: 0.54, trailing_return_pct: 54, average_volume: 1000000 }], leader: 'XLK', leader_score: 0.54, benchmark_return_pct: 2.2, strategy_return_pct: 3.2, average_volume_ratio: 1.1 },
          { date: '2025-12-31', rankings: [{ symbol: 'XLE', target_weight: 1, score: 0.4, trailing_return_pct: 40, average_volume: 1000000 }, { symbol: 'XLK', target_weight: 0, score: 0.39, trailing_return_pct: 39, average_volume: 1000000 }], holdings: [{ symbol: 'XLE', target_weight: 1, score: 0.4, trailing_return_pct: 40, average_volume: 1000000 }], leader: 'XLE', leader_score: 0.4, benchmark_return_pct: 2.3, strategy_return_pct: 3.3, average_volume_ratio: 1.1 },
        ],
        equity_curve: [{ date: '2025-12-31', strategy_equity: 110, benchmark_equity: 105, strategy_drawdown_pct: -3, benchmark_drawdown_pct: -4 }],
        metrics: { total_return_pct: 10, benchmark_return_pct: 5, excess_return_pct: 5, annualized_return_pct: 9, max_drawdown_pct: -3, benchmark_max_drawdown_pct: -4, win_rate_pct: 60, average_turnover_pct: 20, average_volume_participation_ratio: 1.1 },
      }), { status: 200, headers: { 'Content-Type': 'application/json' } }),
    )
