      ...
      <div className="summary-card">
        <div className="split-grid compact-split-grid strategy-lab-config-grid">
          ...
          <label className="field-group">
            ...
            <p className="helper">Leave blank to omit. If set, use a decimal greater than 0 and up to 1, no lower than max position weight. ETF ranking handoffs carry no sector labels, so the cap evaluates as not_evaluated.</p>
